<script lang="ts">
  ...
  let {
    ...
    /**
     * Tiles render with the user's actual letters color (issue #47) — the
     * letters-color-aware .checkerboard backdrop keeps them legible where
     * theme-colored letters on theme-colored tiles used to fail (#46).
     */
    lettersColor: string;
    selectedId: string;
